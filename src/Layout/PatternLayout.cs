...
namespace log4net.Layout
{
    ...
    /// <remarks>
    /// <para>
    /// The goal of this class is to <see cref="M:PatternLayout.Format(TextWriter,LoggingEvent)"/> a <see cref="LoggingEvent"/> as a string. 
    /// 该类的目标是将LoggingEvent格式化（PatternLayout.Format(TextWriter,LoggingEvent)）为字符串。
    /// The results depend on the <i>conversion pattern</i>.
    /// 结果取决于转换模式。
    /// </para>
    /// <para>
    ...
    public class PatternLayout : LayoutSkeleton
	{
        ...
        /// <para>
        /// Default pattern string for log output. 
        /// Currently set to the string <b>"%message%newline"</b> which just prints the application supplied message. 
        /// 
        /// </para>
        /// </remarks>
